...
namespace NTierArchitecture.Service.Services
{
    public class Service<T> : IService<T> where T : class
    {
        ...
        {
            // Geri dönüş değeri IQueryable olduğu için ToListAsync ile veritabanına gitmesini sağladık.
        ...
        {
            _repository.Remove(entity); //Remove'un async bir metodu olmdğı için await dğil
            await _unitOfWork.CommitAsync();
        }
